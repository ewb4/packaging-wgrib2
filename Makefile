3rd-party/wgrib2.tgz:
	curl https://www.ftp.cpc.ncep.noaa.gov/wd51we/wgrib2/wgrib2.tgz.v3.1.1 -o 3rd-party/wgrib2.tgz
...
lambda-wgrib2: 3rd-party/cmake.tgz 3rd-party/wgrib2.tgz
	docker build --target lambda-base -t lambda-wgrib2:v3.1.1 .

.PHONY: lambda-pygrib2
lambda-pywgrib2: 3rd-party/cmake.tgz 3rd-party/pywgrib2_s.py
	docker build --target lambda-pybase -t lambda-pywgrib2:v3.1.1 .
